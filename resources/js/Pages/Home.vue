<template>
  ...
  <div
    :key="showYellow"
    :class="[
      'flex h-screen pt-96 justify-stretch z-50',
      showYellow ? 'flex-row space-x-[30rem]' : 'flex-row-reverse space-x-[30rem] space-x-reverse'
    ]"
  >
    <!-- Left Side (Swiper) -->
    <div class="z-50 pl-5" :data-aos="showYellow ? 'fade-right' : 'fade-left'">
      <Swiper
    ...
    <!-- Right Side (Form) -->
    <div class="w-96 z-50" :data-aos="showYellow ? 'fade-left' : 'fade-right'">
      ...
      <div class="mt-36">
        <button class="w-full rounded-md py-2 text-red-600 text-xl">
