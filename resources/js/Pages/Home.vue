<template>
    <Head title=" - Home" />
    <div
        class="flex -translate-x-[50vw] duration-500 ease-in-out *:w-[50vw]"
        id="container"
    >
        <!-- Left Carousel -->
        ...
        <!-- Center Form -->
        <div
            class="relative flex flex-col items-center justify-center overflow-hidden p-8"
            data-aos="fade-right"
        >
            <div class="relative z-10 w-full max-w-md">
                ...
                <div class="mb-8 text-center">
                    <img
                        :src="basePath + logo"
                        alt="CallTek Logo"
                        class="w-96 object-contain p-2 md:h-full lg:w-full"
                    />
                    <p class="text-xl font-extrabold text-gray-600">
                        Daily Time Record
                    </p>
                </div>
                ...
                <form
                    ...
                    class="rounded-2xl border border-gray-100 bg-white/80 p-8 shadow-lg backdrop-blur-sm"
                >
                    <label
                        for="employeeID"
...
const submitForm = () => {
    ...
    formData.post(route("get-schedules"), {
        ...
        onSuccess: () => {
            ...
            formData.reset();
            setTimeout(
                () => document.getElementById("confirmDtrButton")?.focus(),
                0,
            );
        },
    });
...
const confirmDtrSubmit = () => {
    ...
    confirmDtrSubmitForm.post(route("confirm-dtr"), {
        onSuccess: () => {
            Swal.fire({
                title: "Success",
                text: page.props.success || "DTR recorded successfully.",
                icon: "success",
