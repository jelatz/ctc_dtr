...
const images = [
    { src: `${basePath}/images/tony_espinoza.jpg`, caption: "Tony Espinoza", description: "Sir Tony has dedicated his professional life to creating technology solutions that help businesses turn obstacles into opportunities.", position: "CEO" },
    { src: `${basePath}/images/danny_wu.jpg`, caption: "Danny Wu", description: "Sir Danny's involvement with global IT operations, vendor management, and data center operations gives him a high level of expertise.", position: "VP Global Operations" },
    { src: `${basePath}/images/cher.jpg`, caption: "Cher", description: "As the head of HR/Admin, Cher is good at strategy and her ability to organize makes her one of our strongest leaders.", position: "HR Admin" },
    { src: `${basePath}/images/lizzie.jpg`, caption: "Lizzie", description: "Lizzie is headstrong, strong-willed, and practically fearless which is a vital quality as an operations Manager.", position: "Operations Manager" },
    { src: `${basePath}/images/cathleen.jpg`, caption: "Cathleen", description: "Smart, tough, and hard-working, these qualities make Cathleen an effective operations Manager.", position: "Operations Manager" },
    { src: `${basePath}/images/jane.jpg`, caption: "Jane", description: "Jane is an independent thinker and is responsible for helping manage our new global workforce.", position: "Operations Manager" },
    { src: `${basePath}/images/yanni.jpg`, caption: "Yanni", description: "Yanni is resilient, optimistic, and extremely dedicated to her craft.", position: "Operations Manager" },
];
